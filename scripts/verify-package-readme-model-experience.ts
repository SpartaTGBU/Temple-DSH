...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-mempalace-dashboard': { kind: 'none', reason: 'Browser-side memory inspection projection; registers nothing model-facing.' },
  ...
  'packages/api/mempalace-dashboard': { kind: 'none', reason: 'Read-only memory inspection API; it registers no prompt, tool, or session event.' },
