...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  memory: 'memory.md',
  memoryPressure: 'memory-pressure.md',
  sessionResidency: 'session-residency.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  MemoryGraphRequest: 'memory.md',
  MemoryGraphNode: 'memory.md',
  MemoryGraphEdge: 'memory.md',
  MemoryGraphVisit: 'memory.md',
  MemoryGraphResult: 'memory.md',
  MemoryStatus: 'memory.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  MemoryPressureSample: 'memory-pressure event payload is owned by packages/runtime-diagnostics/memory-pressure/README.md',
  MemoryPressureLevel: 'memory-pressure level enum is owned by packages/runtime-diagnostics/memory-pressure/README.md',
  ResidencyExecutor: 'residency executor seam is owned by packages/session/session-residency/README.md',
  EvictionPlan: 'residency plan result is owned by packages/session/session-residency/README.md',
  EvictionCandidate: 'residency candidate record is owned by packages/session/session-residency/README.md',
  LastActiveAt: 'residency last-active accessor is owned by packages/session/session-residency/README.md',
  SessionListing: 'memory-meter store surface is owned by packages/util/memory-meter/README.md',
